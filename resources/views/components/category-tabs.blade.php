    ...
    <ul class="flex flex-wrap text-sm font-medium text-center justify-center text-body">
        <li class="">
            <a href="{{ route('dashboard') }}"
                class="{{ request('category') ? 'inline-block px-4 py-2 rounded-base hover:text-heading hover:bg-neutral-secondary-soft' : 'inline-block px-4 py-2 text-white bg-brand rounded-base active' }} "
