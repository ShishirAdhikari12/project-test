<x-app-layout>
    <div class="py-4">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-3xl text-blue-900 font-semibold mb-4">Create New Post</h1>
                ...
                <form action="{{ route('post.store') }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-area-input id="content" class="block mt-1 w-full" rows="6" name="content"
                            :value="old('content')">{{ old('content') }}</x-text-area-input>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="published_at" class="block mt-1 w-full" type="datetime-local" name="published_at"
                            :value="old('published_at', now()->setTimezone(config('app.timezone'))->format('Y-m-d\TH:i'))" />
